...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var next_headers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! next/headers */ \"(rsc)/./node_modules/next/dist/api/headers.js\");\n/* harmony import */ var _configs_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/configs/db */ \"(rsc)/./configs/db.tsx\");\n/* harmony import */ var _configs_schema__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/configs/schema */ \"(rsc)/./configs/schema.ts\");\n/* harmony import */ var drizzle_orm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! drizzle-orm */ \"(rsc)/./node_modules/drizzle-orm/sql/expressions/conditions.js\");\n\n\n\n\n\n// Middleware para validar API Key\nasync function validateApiKey(apiKey) {\n    const key = await _configs_db__WEBPACK_IMPORTED_MODULE_2__.db.select().from(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.apiKeysTable).where((0,drizzle_orm__WEBPACK_IMPORTED_MODULE_4__.eq)(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.apiKeysTable.key, apiKey)).limit(1);\n    return key.length > 0;\n}\nasync function GET(req) {\n    try {\n        const headersList = await (0,next_headers__WEBPACK_IMPORTED_MODULE_1__.headers)();\n        const authorization = headersList.get('authorization');\n        if (!authorization?.startsWith('Bearer ')) {\n            return new next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse('API key required', {\n                status: 401\n            });\n        }\n        const apiKey = authorization.split(' ')[1];\n        const isValidKey = await validateApiKey(apiKey);\n        if (!isValidKey) {\n            return new next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse('Invalid API key', {\n                status: 401\n            });\n        }\n        // Parámetro de búsqueda por título\n        const { searchParams } = new URL(req.url);\n        const query = searchParams.get('query') || '';\n        let animes = [];\n        if (query) {\n            animes = await _configs_db__WEBPACK_IMPORTED_MODULE_2__.db.select().from(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.animesTable).where((0,drizzle_orm__WEBPACK_IMPORTED_MODULE_4__.ilike)(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.animesTable.title, `%${query}%`));\n        } else {\n            animes = await _configs_db__WEBPACK_IMPORTED_MODULE_2__.db.select().from(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.animesTable).limit(10);\n        }\n        // Actualizar lastUsed\n        await _configs_db__WEBPACK_IMPORTED_MODULE_2__.db.update(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.apiKeysTable).set({\n            lastUsed: new Date()\n        }).where((0,drizzle_orm__WEBPACK_IMPORTED_MODULE_4__.eq)(_configs_schema__WEBPACK_IMPORTED_MODULE_3__.apiKeysTable.key, apiKey));\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            animes\n        });\n    } catch (error) {\n        console.error('Error fetching anime data:', error);\n        return new next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse('Internal Server Error', {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/v1/anime/route.ts\n");
